...
"""AI Task integration for OpencodeZen."""
...
async def async_setup_entry(
    ...
    for subentry in config_entry.subentries.values():
        ...
        async_add_entities(
            [OpencodeZenAITaskEntity(config_entry, subentry)],
            config_subentry_id=subentry.subentry_id,
        )


class OpencodeZenAITaskEntity(
    ai_task.AITaskEntity,
    OpencodeZenEntity,
):
    """OpencodeZen AI Task entity."""
    ...
    async def _async_generate_data(
        ...
        try:
            ...
            raise HomeAssistantError(
                "Error with OpencodeZen structured response"
            ) from err
