...
def _adjust_schema(schema: dict[str, Any]) -> None:
    """Adjust the schema to be compatible with OpencodeZen API."""
...
def _format_structured_output(
    ...
    """Format the schema to be compatible with OpencodeZen API."""
    result: JSONSchema = {
        "name": name,
        "strict": True,
    }
...
async def _transform_response(
    ...
    """Transform the OpencodeZen message to a ChatLog format."""
        ...
        for file_path, mime_type in files:
            ...
            if not mime_type or not mime_type.startswith(("image/", "application/pdf")):
                raise HomeAssistantError(
                    "Only images and PDF are supported by the OpencodeZen API, "
...
class OpencodeZenEntity(Entity):
    """Base entity for OpencodeZen."""
    ...
    async def _async_handle_chat_log(
        ...
        model_args = {
            ...
            "extra_headers": {
                ...
                "HTTP-Referer": "https://www.home-assistant.io/integrations/opencode_zen",
            },
